...
-- tabloyu eski haline döndüriyoruz
update insanlar
set isim=null
where isim='NO NAME';
...
/* ----------------------------------------------------------------------------
  ORNEK2: kisiler tablosunu maaşa göre ters sıralayarak sorgulayınız.
 -----------------------------------------------------------------------------*/ 
 select * from kisiler
 order by maas desc;
 
 /* ----------------------------------------------------------------------------
  ORNEK4: ismi Mine olanları, maas  göre AZALAN sırada sorgulayınız.
-----------------------------------------------------------------------------*/
select * from kisiler
where isim='Mine'
order by maas desc;
...
select * from kisiler
where soyisim='Bulut'
order by maas ; -- order by maaşın yerine maaşa denk gelen sıra numarası olan 5 yazarakta run edebiliriz.
...
select * from kisiler limit 10,2; -- ilk sayı dahil değil (11 den başla), 2.say kadar git (2 tane girer)
